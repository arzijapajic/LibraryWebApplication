            ...
            if (this.$formCart.length) {
                ...
                if (items.length == 0) {
                    ...
                    for (var i = 0; i < items.length; ++i) {
                        ...
                        html += "</td><td class='pdelete'><a href='' data-product='" + product + "'>&times;</a></td></tr>";
                ...
                if (cartItems.length > 0) {
                    ...
                    for (var j = 0; j < cartItems.length; ++j) {
                        ...
                        var cartHTML = "<tr><td class='pname'>" + cartProduct + "</td>";
...
function myFunction() {
    ...
    var nodes = document.getElementsByClassName('product-description');
